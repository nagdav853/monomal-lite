...
let g:colors_name="monomal-lite"
...
" Color Variables
" ==========================
let s:voidBlack = {'gui': '#141B1B', 'cterm256': '234'}
let s:voidBlack2 = {'gui': '#1D2828', 'cterm256': '235'}
let s:voidGray1 = {'gui': '#495159', 'cterm256': '237'}
let s:voidGray2 = {'gui': '#65707A', 'cterm256': '239'}
let s:voidGray3 = {'gui': '#95A5B4', 'cterm256': '242'}
let s:voidGray4 = {'gui': '#909499', 'cterm256': '249'}
let s:voidSteel = {'gui': '#C6CBD2', 'cterm256': '252'}
let s:voidBlue = {'gui': '#52768A', 'cterm256': '109'}
let s:voidGreen = {'gui': '#536463', 'cterm256': '72'}
let s:voidGold = {'gui': '#66604C', 'cterm256': '136'}
let s:voidRed = {'gui': '#645353', 'cterm256': '1'}
let s:voidRed2 = {'gui': '#422525', 'cterm256': '196'}
